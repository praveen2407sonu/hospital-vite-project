        ...
        <div className="lg:w-1/2 bg-white border border-gray-200 rounded-lg shadow-md p-8">
          ...
          <form className="flex flex-col gap-4">
            ...
            >
              ...
              <option>Dr. Amit Sharma (Cardiology)</option>
              <option>Dr. Neha Verma (Neurology)</option>
              <option>Dr. Rajesh Kumar (Orthopedics)</option>
              <option>Dr. Pooja Singh (Pediatrics)</option>
              <option>Dr. Anil Mehta (General Surgery)</option>
              <option>Dr. Kavita Rao (ENT)</option>
            </select>
